...
```json
"features": {
    "ghcr.io/gauravsaini04/features/nvidia-cuda:2": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/gauravsaini04/features/blob/main/src/nvidia-cuda/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
