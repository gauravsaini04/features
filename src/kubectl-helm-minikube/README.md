...
```json
"features": {
    "ghcr.io/gauravsaini04/features/kubectl-helm-minikube:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/gauravsaini04/features/blob/main/src/kubectl-helm-minikube/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
